  ...
  return (
    <div className='flex-c w-[100vw] secondary-c'>
      ...
      <div className='flex-c items-center py-12 px-6'>
        <h1 className='text-5xl font-bold text-[#60a5fa] mb-4 text-center'>
          Asylum Office Grant Rate Tracker
        </h1>
        <p className='text-lg text-[#60a5fa] text-center max-w-4xl'>
      ...
      <div className='flex-c items-center py-8 px-6'>
        <div className='flex flex-wrap justify-center gap-8 mb-8 max-w-7xl'>
          <div className='flex-c items-center'>
            ...
            <h3 className='text-[#60a5fa] font-semibold text-center'>Search Grant Rates By Office</h3>
          </div>
          <div className='flex-c items-center'>
            <img src={pieChart} alt='Grant Rates By Nationality' className='w-64 h-48 object-contain mb-4' />
            <h3 className='text-[#60a5fa] font-semibold text-center'>Search Grant Rates By Nationality</h3>
          </div>
          <div className='flex-c items-center'>
            <img src={lineGraph} alt='Grant Rates Over Time' className='w-64 h-48 object-contain mb-4' />
            <h3 className='text-[#60a5fa] font-semibold text-center'>Search Grant Rates Over Time</h3>
          </div>
        </div>
        ...
        <div className='flex gap-4 mt-8'>
          <button 
            ...
            className='px-6 py-3 border-2 border-[#60a5fa] text-[#60a5fa] rounded hover:bg-[#60a5fa] hover:text-white transition-colors'
          >
            View the Data
          </button>
          <button 
      ...
      <div className='flex flex-wrap items-center justify-center gap-8 py-12 px-6 max-w-7xl mx-auto'>
        ...
        <div className='flex-1 max-w-2xl'>
          <p className='text-[#60a5fa] text-lg leading-relaxed'>
      ...
      <div className='flex-c items-center py-12 px-6 bg-white'>
        <h2 className='text-4xl font-bold text-[#60a5fa] mb-12 text-center'>
        ...
        <div className='flex flex-wrap justify-center gap-8 max-w-6xl mb-8'>
          <div className='flex-c items-center max-w-xs text-center'>
            <div className='text-6xl font-bold text-[#60a5fa] mb-4'>36%</div>
          ...
          <div className='flex-c items-center max-w-xs text-center'>
            <div className='text-6xl font-bold text-[#60a5fa] mb-4'>5%</div>
            <p className='text-[#60a5fa] text-base leading-relaxed'>
              The New York asylum office grant rate dropped to 5 percent in fiscal year 2020.
            </p>
          </div>
          <div className='flex-c items-center max-w-xs text-center'>
            <div className='text-6xl font-bold text-[#60a5fa] mb-4'>6x Lower</div>
            <p className='text-[#60a5fa] text-base leading-relaxed'>
        ...
        <div className='flex-c items-center gap-4'>
          <button 
            ...
            className='px-8 py-3 border-2 border-[#60a5fa] text-[#60a5fa] rounded hover:bg-[#60a5fa] hover:text-white transition-colors'
          >
            Read More
          </button>
          <button 
